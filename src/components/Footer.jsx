...
const Footer = ({ black }) => {
  ...
  return (
    <footer className={`${black} border-t border-gray-300 dark:border-gray-700`}>
      <div className="p-6 md:px-10 lg:px-20 py-10 md:py-12 grid gap-10 md:grid-cols-3 items-start">
        {/* CONTACT SECTION */}
        <div className="space-y-4 text-center md:text-left">
          <h1 className="text-xl font-bold text-white flex justify-center md:justify-start items-center gap-2">
            <MdCall size={28} className="hover:animate-bounce" /> CALL
          </h1>
          <a
        ...
        <div className="space-y-4 text-center md:text-left">
          <h1 className="text-xl font-bold text-white flex justify-center md:justify-start items-center gap-2">
            <IoMdMail size={28} className="hover:animate-bounce" /> EMAIL
          </h1>
          <a
      ...
      {/* SOCIAL + COPYRIGHT */}
      <div className="border-t border-gray-300 dark:border-gray-700 pt-6 pb-4 flex flex-col md:flex-row justify-between items-center gap-4 md:px-20">
