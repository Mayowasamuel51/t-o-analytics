          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 text-center leading-relaxed mb-6">
                You can now easily access <span className="text-blue-400 font-semibold">all Splunk commands</span>{" "}
                inside the <span className="text-purple-400 font-semibold">Dashboard section</span>.
              </p>
              <motion.button
...
//   useEffect(() => {
//     // ✅ Fixed key mismatch ("sFeature" vs "seFeature")
//     const hasSeen = localStorage.getItem("newFeatureSeen");
//     if (!hasSeen) {
//       setTimeout(() => setShow(true), 800); // delay for subtle effect
...
//                   Splunk job opportunities
//                 </span>{" "}
//                 {/* directly after finishing your quiz. */}
//               </p>
