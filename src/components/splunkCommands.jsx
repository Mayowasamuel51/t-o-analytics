...
const SplunkCommands = () => {
    ...
    useEffect(() => {
        ...
        const data = {
            ...
            description: "Read all the documents below carefully and complete the required tasks.",
            docs: [
                {
                  id: 1,
                ...
                <div className="flex flex-wrap gap-3 mb-4">
                    {assignment.docs.map((doc) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${selectedDoc?.id === doc.id
