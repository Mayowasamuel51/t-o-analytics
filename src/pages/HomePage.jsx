            ...
            <div className="md:p-10 p-2 overflow-x-hidden">
                <div className="md:pb-20 grid grid-cols-1 md:grid-cols-2 items-center gap-20">
                    <div data-aos-once="true" data-aos-duration="6000" data-aos="fade-right">
                        ...
                        <p className=" font-medium   text-sm md:text-lg">Our instructors are seasoned professionals with extensive experience in diverse areas of the tech industry. They leverage their deep expertise and real-world project insights to deliver practical, actionable guidance in the classroom.</p>
                    </div>
