  ...
  return (
    <>
        <section className="px-2 py-24 md:py-20 md:px-10 bg-white border-red-500">
            <div>
                <h1 className="my-4 md:my-8 font-bold text-2xl md:text-4xl">Our Mission</h1>
                <p className="w-full md:w-1/2 font-light text-sm md:text-lg my-3">At T.O Analytics, our mission is to empower students with the essential tech skills, focusing on the field of Cybersecurity. We understand the importance of cybersecurity in today’s digital world, protecting the individuals and organizations from cyber threats. </p>
            </div>
        </section>
        <section className="px-2 py-10 md:p-10 bg-white font-bold">
