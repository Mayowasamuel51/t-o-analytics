  ...
  return (
    <>
                ...
                <div>
                    ...
                    <div className="flex gap-2 md:gap-3">
                        <a href="bookmentorship.html">
                            <button className="text-base md:text-xl font-semibold border-2 border-BLUE text-BLUE hover:text-white hover:bg-BLUE px-2 py-3 md:px-4 md:py-3 rounded-lg md:rounded-xl duration-300">Book Mentorship</button>
                        </a>
                        <a href=" ">
                            <button className="text-base md:text-xl font-semibold border-2 border-BLUE bg-BLUE text-white hover:bg-white hover:text-BLUE px-2 py-3 md:px-4 md:py-3 rounded-lg md:rounded-xl duration-300">Live Courses</button>
                        </a>
                    </div>
                </div>
        ...
        <section className="bg-white">
            <h1 className="py-6 text-center font-bold text-2xl md:text-4xl">Why Trust T.O Analytics?</h1>
            <div className="md:p-10 p-2 overflow-x-hidden">
                <div className="pb-10 md:pb-24 grid grid-cols-1 md:grid-cols-2 items-center gap-20">
                ...
                <div className="py-10 md:py-24 grid grid-cols-1 md:grid-cols-2 items-center gap-20">
        ...
        <section className="courses p-2 md:p-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-4 gap-x-2">
                <a href="splunk.html">
                    <div className="" data-aos-once="true" data-aos-duration="6000" data-aos="fade-up" data-aos-delay="100" data-aos-easing="ease-in-out">
                        <div>
                            <img src="./images/splunk.png" className="rounded-tr-2xl rounded-tl-2xl" alt="" />
                        </div>
                ...
                <a href="DATA.html">
                    <div className="" data-aos-once="true" data-aos-duration="6000" data-aos="fade-up" data-aos-delay="200" data-aos-easing="ease-in-out">
                        <div>
                            <img src="./images/b-analytics.png" alt="" />
                        </div>
                        <div className="text-white p-4 rounded-bl-2xl rounded-br-2xl bg-BLUE">
            ...
            <div className="py-10 text-center">
                <a href="courses.html" className="">
                    <button className="text-md md:text-xl font-light bg-BLUE hover:bg-transparent hover:text-BLUE duration-300 hover:outline-2 outline hover:outline-BLUE text-white px-4 py-4 rounded-xl">View All Courses</button>
                </a>
            </div>
        </section>
        ...
        <section className="">
            <div className="bg-BLUE text-white rounded-lg border-[1px] border-PURPLE mx-2 md:mx-10 grid grid-cols-1 lg:grid-cols-2">
                <div className="flex justify-center items-center">
                    <div className="p-4">
                        <img src="./images/client.png" className="w-[450px] md:border-[1px] border-PURPLE rounded-2xl" alt="" />
                        <div className="text-center">
                            <p className="font-medium my-2 md:text-2xl">Tomide Olulana</p>
                            <p className="font-light text-lg md:text-2xl my-2">CEO</p>
                        </div>
                    </div>
                </div>
        ...
        <section className="bg-white p-2">
            <h1 className="my-2 md:my-8 text-center font-bold text-lg md:text-4xl">Here’s what our students are saying</h1>
            <Splide className='splide pb-10' aria-label="Testimonials" options={{
                ...
                <SplideSlide>
                    <div className="md:w-1/2 mx-auto">
                        ...
                        <div className="flex items-center justify-center gap-1 md:gap-3">
                            <img src="./images/student1.png" className="w-[40px] md:w-[70px] aspect-square rounded-full" alt=""/>
                ...
                <SplideSlide>
                    <div className="md:w-1/2 mx-auto">
                        ...
                        <div className="flex items-center justify-center gap-1 md:gap-3">
                            <img src="./images/student2.png" className="w-[40px] md:w-[70px] aspect-square rounded-full" alt=""/>
                ...
                <SplideSlide>
                    <div className="md:w-1/2 mx-auto">
                        ...
                        <div className="flex items-center justify-center gap-1 md:gap-3">
                            <img src="./images/student3.jpeg" className="w-[40px] md:w-[70px] aspect-square rounded-full" alt=""/>
        ...
        <section class="text-center p-10 bg-black text-white">
            <h1 class="my-4 md:my-12 text-center font-bold text-xl md:text-4xl">Ready to take your career to new heights?</h1>
            ...
            <div class="text-center">
                <a href="contractorpage.html" class="">
                    <button class="hover:bg-transparent hover:text-BLUE duration-300 border-BLUE hover:border-BLUE border-2 w-fit mx-auto text-md md:text-xl font-semibold bg-BLUE text-white px-4 py-4 md:px-3 md:py-3 mt-8 rounded-xl">Connect with Contractor</button>
                </a>
            </div>
        </section>
